...
for i in $(seq 1 $Iterations); do
  ...
  if [ $Ploidy == "haploid" ]; then
    java -Xmx60G -jar /mnt/shared/scratch/jnprice/apps/conda/pkgs/pilon-1.24-hdfd78af_0/share/pilon-1.24-0/pilon.jar --threads $Threads --genome assembly.fa --changes --frags assembly.fa_aligned_sorted.bam --outdir .
