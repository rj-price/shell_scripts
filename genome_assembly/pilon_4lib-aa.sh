...
echo "Forward trimmed reads - $Read_F1 $Read_F2 $Read_F3 $Read_F4"
echo "Reverse trimmed reads - $Read_R1 $Read_R2 $Read_R3 $Read_R4"
echo "OutDir - $OutDir"
...
cp $CurDir/$Read_F3 $Read_F3
cp $CurDir/$Read_R3 $Read_R3
cp $CurDir/$Read_F4 $Read_F4
cp $CurDir/$Read_R4 $Read_R4
...
for i in $(seq 1 $Iterations); do
  ...
  bowtie2 -p 24 -x assembly.fa.indexed -1 $WorkDir/$Read_F1,$WorkDir/$Read_F2,$WorkDir/$Read_F3,$WorkDir/$Read_F4 -2 $WorkDir/$Read_R1,$WorkDir/$Read_R2,$WorkDir/$Read_R3,$WorkDir/$Read_R4 -S assembly.fa_aligned.sam
